...
class Instrument:
    ...
    classdocs
    '''
    def __init__(self, ID, name, current_outstanding, monthly_cost, account_type):
        '''
        Constructor
        '''
        self.ID = ID
...
class CurrentAccount(Instrument):
    ...
    classdocs
    '''
    def __init__(self, ID, name, current_outstanding, monthly_cost, account_type, cnit):
        '''
        Constructor
        '''
        super().__init__(ID, name, current_outstanding, monthly_cost, account_type)
        self.cnit = cnit
